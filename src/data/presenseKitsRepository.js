...
// Todas las lecturas/escrituras de kits PreSense van contra el backend, sin
...
export async function getAll() {
  return fetchJson(`${API_BASE_URL}/presense-kits`);
}

export async function add(kit) {
  return fetchJson(`${API_BASE_URL}/presense-kits`, {
    method: "POST",
    headers: {
...
export async function update(id, cambios) {
  return fetchJson(`${API_BASE_URL}/presense-kits/${encodeURIComponent(id)}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
      ...getAuthHeader(),
