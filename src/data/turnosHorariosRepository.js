...
// Todas las lecturas/escrituras de turnos horarios van contra el backend,
// sin localStorage ni catálogos hardcodeados.
...
export async function getAll() {
  return fetchJson(`${API_BASE_URL}/turnos-horarios`);
}

export async function add(turno) {
  return fetchJson(`${API_BASE_URL}/turnos-horarios`, {
    method: "POST",
    headers: {
...
export async function update(id, cambios) {
  return fetchJson(`${API_BASE_URL}/turnos-horarios/${encodeURIComponent(id)}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
      ...getAuthHeader(),
